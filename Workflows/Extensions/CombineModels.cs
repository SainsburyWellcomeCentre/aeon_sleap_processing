...
public class CombineModels
{
    ...
    public IObservable<PoseIdentityCollection> Process(IObservable<Tuple<PoseIdentityCollection, PoseCollection>> source)
    {
        return source.Select(value =>
        {
            ...
            // output.Model.ClassNames = poseIdentities.Model.ClassNames;

            // Return empty output if no poses or identities
            if (poses.Count == 0 || poseIdentities.Count == 0 || poseIdentities == null)
            {
            ...
            for (int i = 0; i < assignments.Length; i++)
            {
                ...
                // updatedPoseIdentity.Model.ClassNames = poseIdentities.Model.ClassNames;
                ...
                else
                {
                    ...
                    updatedPoseIdentity.IdentityScores = identity.IdentityScores;
                }
